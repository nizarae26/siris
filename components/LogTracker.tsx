...
export default function LogTracker({ logs }: LogTrackerProps) {
  return (
    <div className="bg-white/90 backdrop-blur-sm shadow-xl rounded-2xl p-6 w-full border border-gray-100">
      ...
      {logs.length === 0 ? (
        ...
        <ul className="space-y-3 overflow-y-auto max-h-[320px] pr-2 custom-scrollbar">
